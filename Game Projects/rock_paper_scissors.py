...
# Input either "rock", "paper", "scissors" to play or "q" to quit.
# The program keeps track of number of computer and player wins.
...
while True:
    ...
    if player_hand == 'rock':
        if computer_hand == 'scissors':
            ...
            player_points += 1 
            print(f"Player score: {player_points}    Computer's score: {computer_points}")
            print(" ")
        else:
            print('Paper beats rock! You lose!')
            computer_points += 1
            print(f"Computer's score: {computer_points}    Player score: {player_points}")
            print(" ")
